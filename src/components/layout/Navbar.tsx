...
const navItems: { key: string; path: string; labelKey?: string; match?: string[] }[] = [
  ...
  { key: 'timemap', path: '/zaman-haritasi', labelKey: 'timemap', match: ['/zaman-haritasi', '/timeline'] },
  { key: 'statistics', path: '/statistics', labelKey: 'stats_compare', match: ['/statistics', '/compare', '/network-insights', '/veri-sagligi', '/etki-kanon', '/muhitler', '/kesif'] },
